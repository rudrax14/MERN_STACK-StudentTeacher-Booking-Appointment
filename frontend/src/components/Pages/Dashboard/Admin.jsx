    ...
    <>
      ...
      <div className="header-container shadow p-3 mb-5 bg-danger text-white ">
        <div className="container d-flex justify-content-center">
          <p className='fs-1'>Admin Dashbord</p>
        </div>
      </div>
      {/* modal */}
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form>
                <div class="mb-3">
                  <label for="subjectName" class="form-label">Teacher Name</label>
                ...
                <div class="mb-3">
                  <label for="subjectName" class="form-label">Department</label>
                  <input type="text" class="form-control" id="subjectName" />
                </div>
